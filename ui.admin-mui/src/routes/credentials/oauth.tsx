...
const OAuth = () => {
  useDidMount(async () => {
    try {
      ...
      console.groupEnd();
      localStorage['cached-logged-user'] = JSON.stringify({
        ...data, scopes: twitchValidation.data.scopes,
      });

      axios.post('https://1ccf-213-155-246-230.ngrok-free.app/user', undefined, twitchHeaders).finally(() => {
