...
const PageSettingsModulesIntegrationsDonationAlerts: React.FC<{
  ...
  const { settings, loading, refresh, save, saving, errors } = useSettings('/integrations/donationalerts' as any);
  ...
  const authorize = useCallback(() => {
    ...
    const checkPopup = setInterval(() => {
      try {
        ...
        // ignore cross origin error which may happen when donationalerts is authorizing
      }
