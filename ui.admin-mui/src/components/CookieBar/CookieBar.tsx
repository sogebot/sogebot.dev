...
import {
  Box,
  Button, Dialog, DialogActions, DialogContent, DialogContentText, Fade, FormControlLabel, FormGroup, Paper, Stack, Typography,
} from '@mui/material';
...
import { toggleCookieManager } from '~/src/store/loaderSlice';
